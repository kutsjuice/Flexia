mutable struct Marker <: AbstractMarker2D
    ...
    function first_marker(name::String, body::Body2D)
        ...
        point_on_body = get_boundary_points(sys::MBSystem2D, body::Body2D, dofs::AbstractVector{Float64}, 1)
    ...
    function second_marker(name::String, body::Body2D)
        ...
        point_on_body = get_boundary_points(sys::MBSystem2D, body::Body2D, dofs::AbstractVector{Float64}, 2)
        return new(name, body_index)
    end
end